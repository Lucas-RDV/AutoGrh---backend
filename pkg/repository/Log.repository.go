...
func GetLogByID(id int64) (*entity.Log, error) {
	...
	var l entity.Log
	err := row.Scan(&l.Id, &l.UsuarioId, &l.EventoId, &l.Data, &l.Message)
	if err != nil {
...
// Lista todos os logs (opcional: filtro por usuário)
func GetLogsByUsuarioID(usuarioID int64) ([]*entity.Log, error) {
	...
	for rows.Next() {
		var l entity.Log
		err := rows.Scan(&l.Id, &l.UsuarioId, &l.EventoId, &l.Data, &l.Message)
		if err != nil {
